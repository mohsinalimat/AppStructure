...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BKMoneyKit/BKMoneyKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNNotificationView/RNNotificationView.framework"
